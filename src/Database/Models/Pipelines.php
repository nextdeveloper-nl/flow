...
use NextDeveloper\Flow\Database\Observers\PipelinesObserver;
...
class Pipelines extends Model
{
    ...
    protected $table = 'flow_pipelines';
    ...
    public static function boot()
    {
        ...
        parent::observe(PipelinesObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('flow.scopes.flow_pipelines');
    ...
    {
        return $this->hasMany(\NextDeveloper\Flow\Database\Models\Stages::class);
    }
    ...
    {
        return $this->hasMany(\NextDeveloper\Flow\Database\Models\Columns::class);
    }
