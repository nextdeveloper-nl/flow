...
class FlowManagerRole extends AbstractRole implements IAuthorizationRole
{
    ...
    public const DESCRIPTION = 'Flow manager with full CRUD access to all flow objects within their account.';
    ...
    /**
     * Managers can update any flow object that belongs to their account.
     * For tables without iam_account_id the default parent behaviour applies.
     */
    ...
    /**
     * Managers can delete any flow object that belongs to their account.
     */
