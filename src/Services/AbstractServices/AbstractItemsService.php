...
class AbstractItemsService
{
    public static function get(?ItemsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new ItemsQueryFilter($request);
        }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Items
    {
        return Items::findByRef($ref);
    }
    ...
    {
        $object = Items::where('uuid', $objectId)->first();

        $action = AvailableActions::where('name', $action)
            ->where('input', 'NextDeveloper\Flow\Items')
            ->first();
     ...
     * @return Items|null
     */
    public static function getById($id) : ?Items
    {
    ...
    {
        try {
            $obj = Items::where('uuid', $uuid)->first();
     ...
     * @return Items
     */
    public static function updateRaw(array $data) : ?Items
    {
    ...
    {
        $model = Items::where('uuid', $id)->first();
