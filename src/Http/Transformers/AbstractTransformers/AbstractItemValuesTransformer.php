 ...
 */
class AbstractItemValuesTransformer extends AbstractTransformer
{
    ...
    public function includeStates(ItemValues $model)
    {
    ...
    public function includeActions(ItemValues $model)
    {
    ...
    public function includeMedia(ItemValues $model)
    {
    ...
    public function includeSocialMedia(ItemValues $model)
    {
    ...
    public function includeComments(ItemValues $model)
    {
    ...
    public function includeVotes(ItemValues $model)
    {
    ...
    public function includeMeta(ItemValues $model)
    {
    ...
    public function includePhoneNumbers(ItemValues $model)
    {
    ...
    public function includeAddresses(ItemValues $model)
    {
