 ...
 */
class AbstractItemsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(Items $model)
    {
    ...
    public function includeActions(Items $model)
    {
    ...
    public function includeMedia(Items $model)
    {
    ...
    public function includeSocialMedia(Items $model)
    {
    ...
    public function includeComments(Items $model)
    {
    ...
    public function includeVotes(Items $model)
    {
    ...
    public function includeMeta(Items $model)
    {
    ...
    public function includePhoneNumbers(Items $model)
    {
    ...
    public function includeAddresses(Items $model)
    {
