...
class StageHistoryPerspectiveCreateRequest extends AbstractFormRequest
{
    ...
    public function rules()
    {
        ...
        'from_stage_id' => 'nullable|exists:flow_stages,uuid|uuid',
        'to_stage_id' => 'nullable|exists:flow_stages,uuid|uuid',
